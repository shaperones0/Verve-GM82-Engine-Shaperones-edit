...
//field locked: false
    ...
    //field     locked_behavior: enum("consume", "hold") - "consume" makes any incoming signal be completely ignored while locked, "hold" will hold incoming signals until unlocked
//field count: number - will only send signal if was activated specified number of times before that
//field send_off_signal: false - Sends "off" signal instead of "on", thus disabling most triggers
...
var trig; trig = ternary(send_off_signal, ev_trigger_off, ev_trigger_on)
